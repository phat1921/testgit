...
<div class="card">
	...
	<form action="{{ route('classroom.update', $classroom->Id_Class) }}" method="post" class="form-horizontal">
		<div class="row">
		@csrf
		@method('PUT')
		...
		<div class="col-md-9">
            <div class="form-group label-floating is-empty">
                 ...
                 <input type="text" class="form-control" name="name" value="{{ $classroom->Name_Class }}" required>
            </div>
        </div>
